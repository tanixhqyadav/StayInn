...
export default function PlaceGallery({ place }) {
        ...
        <div className="bg-black p-6 md:p-8 grid gap-4 w-full max-w-5xl">
          <div className="flex justify-between items-center">
            ...
            <button 
              ...
              className="fixed right-4 md:right-12 top-4 md:top-8 flex gap-1 py-2 px-4 rounded-2xl shadow-lg bg-white text-black"
            >
  ...
  return (
    <div className="relative">
      ...
      <button 
        onClick={() => setShowAllPhotos(true)} 
        className="flex gap-1 absolute bottom-4 right-4 md:bottom-6 md:right-6 py-2 px-4 bg-white rounded-2xl shadow-lg shadow-gray-500"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
